...
def main():
    ...
    # -----------------------start/ initialize  WandB ---------------------------


    # DENSE_HEAD: NAME
    # dense_head_name = cfg.MODEL.DENSE_HEAD.NAME


    wandb_run = wandb.init(
            project='VirConv',
            name = 'Loss_cfg_test', 
            config=cfg,                # store all hyperparameters and configurations in the wandb run
    )


    logger.info('*******Initialized Weights and Biasis**************')
